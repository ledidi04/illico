    ...
    <div class="main-content">
        ...
        <div>
            ...
            <div style="background:linear-gradient(135deg,#1e3a8a 0%,#3b82f6 100%);color:white;padding:26px;border-radius:14px 14px 0 0;">
                ...
                <div>
                    <a href="supprimer_compte.php?id=<?= $compte['id'] ?>&redirect=verification.php?search=<?= urlencode($search) ?>"
                    onclick="return confirm('⚠️ ATTENTION : Ce compte sera définitivement supprimé avec toutes ses transactions. Confirmer la suppression ?')"
                    class="btn btn-danger btn-sm" style="background:#dc2626;color:white;">
