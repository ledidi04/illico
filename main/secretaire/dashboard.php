...
<head>
    <meta charset="UTF-8">
    <title>Secrétaire - S&P illico</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="creer_compte.php"><i class="fas fa-user-plus"></i> Créer compte</a>
    ...
    <div class="main">
        ...
        <div class="card">
            ...
            <p>Utilisez le menu pour gérer les comptes clients et effectuer des opérations.</p>
        </div>
    </div>
</body>
</html>